...
fun fetchGitCommitHash(): String {
    ...
    // Se usa providers.exec en lugar de ProcessBuilder directo porque
    // ProcessBuilder ejecutado en tiempo de configuración es incompatible
    // con la configuration cache de Gradle (ver "external process started
    // 'git rev-parse --short HEAD'" en el reporte de configuration-cache).
    try {
    ...
    return try {
        ...
        val url = URL("https://dhun.free.nf/")
...
android {
    namespace = "com.arturo254.dhun"
    compileSdk = 36

    ndkVersion = "27.1.12297006"

    defaultConfig {
        applicationId = "com.Arturo254.dhun"
        minSdk = 26
        targetSdk = 36
        versionCode = 134
        versionName = "3.0.7"
