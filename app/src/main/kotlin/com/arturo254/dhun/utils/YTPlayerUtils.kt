...
import com.arturo254.dhun.innertube.NewPipeUtils
import com.arturo254.dhun.innertube.YouTube
import com.arturo254.dhun.innertube.models.YouTubeClient
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.IOS
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
...
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_TESTSUITE
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_UNPLUGGED
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.IPADOS
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.IOS_MUSIC
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.MOBILE
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.TVHTML5
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.VISIONOS
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.WEB
import com.arturo254.dhun.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
object YTPlayerUtils {
     ...
     *
     * [com.arturo254.dhun.innertube.models.YouTubeClient.WEB_REMIX] should be preferred here because currently it is the only client which provides:
    ...
    suspend fun playerResponseForPlayback(
        ...
        val attempts =
            when (audioQuality) {
                ...
                AudioQuality.EXTREME -> listOf(AudioQuality.EXTREME, AudioQuality.HIGHEST, AudioQuality.HIGH)
                AudioQuality.ULTRA_HIGH -> listOf(AudioQuality.ULTRA_HIGH, AudioQuality.HIGH)
                AudioQuality.ULTRA_HIGH_PRO -> listOf(AudioQuality.ULTRA_HIGH_PRO, AudioQuality.HIGH)
    ...
    private fun selectAudioFormatCandidates(
        ...
        val targetBitrateBps =
            when (effectiveQuality) {
                ...
                AudioQuality.ULTRA_HIGH -> 256_000
                AudioQuality.ULTRA_HIGH_PRO -> 256_000
                AudioQuality.EXTREME -> 320_000
        ...
        val candidates =
            if (targetBitrateBps == null) {
                ...
                // ULTRA_HIGH prefers Opus codec, ULTRA_HIGH_PRO prefers AAC (mp4a) codec.
                // EXTREME picks the highest bitrate regardless of codec.
                val codecFiltered = when (effectiveQuality) {
                    AudioQuality.ULTRA_HIGH -> audioFormats.filter {
                        extractCodec(it.mimeType)?.lowercase()?.contains("opus") == true
                    }.ifEmpty { audioFormats }
                    AudioQuality.ULTRA_HIGH_PRO -> audioFormats.filter {
                        extractCodec(it.mimeType)?.lowercase()?.let { c ->
                            c.contains("mp4a") || c.contains("aac")
                        } == true
                    }.ifEmpty { audioFormats }
                    AudioQuality.EXTREME -> audioFormats
                    else -> audioFormats
                }
                val belowOrEqual = codecFiltered.filter { it.bitrate <= targetBitrateBps }
