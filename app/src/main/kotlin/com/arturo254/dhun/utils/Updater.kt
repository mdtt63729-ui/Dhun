...
import com.arturo254.dhun.App
import com.arturo254.dhun.constants.GitHubReleasesEtagKey
import com.arturo254.dhun.constants.GitHubReleasesFingerprintKey
import com.arturo254.dhun.constants.GitHubReleasesJsonKey
import com.arturo254.dhun.constants.GitHubReleasesLastCheckedAtKey
import com.arturo254.dhun.constants.UpdateChannel
import com.arturo254.dhun.constants.UpdateChannelKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://dhun.free.nf/") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Dhun")
    ...
    fun getLatestDownloadUrl(): String {
        ...
        return when (channel) {
            UpdateChannel.STABLE -> {
                "https://dhun.free.nf//download/$APK_ASSET_NAME"
            }
            UpdateChannel.NIGHTLY -> {
