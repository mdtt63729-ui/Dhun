...
import com.arturo254.dhun.constants.AlbumSortType
import com.arturo254.dhun.constants.ArtistSongSortType
import com.arturo254.dhun.constants.ArtistSortType
import com.arturo254.dhun.constants.PlaylistSortType
...
import com.arturo254.dhun.db.entities.AlbumArtistMap
import com.arturo254.dhun.db.entities.AlbumEntity
import com.arturo254.dhun.db.entities.PlayCountEntity
import com.arturo254.dhun.db.entities.AlbumWithSongs
...
import com.arturo254.dhun.db.entities.EventWithSong
...
import com.arturo254.dhun.db.entities.PlaylistSong
...
import com.arturo254.dhun.db.entities.SetVideoIdEntity
import com.arturo254.dhun.db.entities.Song
import com.arturo254.dhun.db.entities.SongAlbumMap
import com.arturo254.dhun.db.entities.SongArtistMap
import com.arturo254.dhun.db.entities.SongEntity
import com.arturo254.dhun.db.entities.SongWithStats
import com.arturo254.dhun.db.entities.TagEntity
import com.arturo254.dhun.db.entities.PlaylistTagMap
import com.arturo254.dhun.extensions.reversed
import com.arturo254.dhun.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    // ── AI Translated Lyrics ───────────────────────────────────────────────

    @Query("SELECT * FROM ai_translated_lyrics WHERE videoId = :videoId AND language = :language LIMIT 1")
    fun getAITranslatedLyrics(videoId: String, language: String): kotlinx.coroutines.flow.Flow<AITranslatedLyricsEntity?>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertAITranslatedLyrics(entity: AITranslatedLyricsEntity)

    @Query("DELETE FROM ai_translated_lyrics WHERE videoId = :videoId AND language = :language")
    suspend fun removeAITranslatedLyrics(videoId: String, language: String)

    @Query("DELETE FROM ai_translated_lyrics WHERE videoId = :videoId")
    suspend fun removeAllAITranslatedLyrics(videoId: String)
}
