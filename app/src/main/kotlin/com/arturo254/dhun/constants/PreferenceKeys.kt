...
val DhunCanvasKey = booleanPreferencesKey("DhunCanvas")

// Fuente del canvas: AUTO, APPLE_MUSIC, DHUN, TIDAL
...
// Home Screen Widget (DhunPlayerWidget)
...
// Player / Audio
val CrossfadeDjModeKey = booleanPreferencesKey("crossfadeDjMode")
val CrossfadeSkipAlbumKey = booleanPreferencesKey("crossfadeSkipAlbum")
val SaveLastPlayedKey = booleanPreferencesKey("saveLastPlayed")
val KillServiceOnExitKey = booleanPreferencesKey("killServiceOnExit")
val KeepServiceAliveKey = booleanPreferencesKey("keepServiceAlive")
val PlayExplicitContentKey = booleanPreferencesKey("playExplicitContent")
val CombineLikedSongsKey = booleanPreferencesKey("combineLikedSongs")
val RadioAudioOnlyKey = booleanPreferencesKey("radioAudioOnly")
val PlayVideoInsteadOfAudioKey = booleanPreferencesKey("playVideoInsteadOfAudio")
val SendListeningDataToGoogleKey = booleanPreferencesKey("sendListeningDataToGoogle")
val SyncFollowToYouTubeKey = booleanPreferencesKey("syncFollowToYouTube")
val KeepYouTubePlaylistOfflineKey = booleanPreferencesKey("keepYouTubePlaylistOffline")
...
val VideoDownloadQualityKey = stringPreferencesKey("videoDownloadQuality")
val DownloadQualityKey = stringPreferencesKey("downloadQuality")

// UI / Appearance
val TranslucentBottomBarKey = booleanPreferencesKey("translucentBottomBar")
val LyricsRomanizationKey = booleanPreferencesKey("lyricsRomanization")

// Lyrics
val MainLyricsProviderKey = stringPreferencesKey("mainLyricsProvider")
val TranslationLanguageKey = stringPreferencesKey("translationLanguage")
val YouTubeSubtitleLanguageKey = stringPreferencesKey("youtubeSubtitleLanguage")
val HelpBuildLyricsDatabaseKey = booleanPreferencesKey("helpBuildLyricsDatabase")
val ContributorNameKey = stringPreferencesKey("contributorName")
val ContributorEmailKey = stringPreferencesKey("contributorEmail")
...
// Local tracking
val LocalTrackingEnabledKey = booleanPreferencesKey("localTrackingEnabled")

// Player cache limit (in MB, 0 = unlimited)
val PlayerCacheLimitKey = intPreferencesKey("playerCacheLimit")
...
val AutoBackupMaxFilesKey = intPreferencesKey("autoBackupMaxFiles")
...
// Background gradient (dark mode only): 5 presets (0=lightest, 4=pure black)
val BackGradKey = intPreferencesKey("backGrad")
// Card gradient (dark mode only): 7 presets (0=lightest, 6=pure black)
val CardGradKey = intPreferencesKey("cardGrad")
// Bottom gradient (dark mode only): 5 presets (reuses backGrad palette)
val BottomGradKey = intPreferencesKey("bottomGrad")
// Canvas color: "Grey" or "Black"
val CanvasColorKey = stringPreferencesKey("canvasColor")
// Card color: "Grey800", "Grey850", "Grey900", "Black"
val CardColorKey = stringPreferencesKey("cardColor")
// Saved user themes (JSON map of theme name -> properties)
val SavedThemesKey = stringPreferencesKey("savedThemes")

// === BlackHole-ported player/UI settings ===

// Player screen background gradient type
val PlayerGradientTypeKey = stringPreferencesKey("playerGradientType")
// Use dense mini player
val UseDenseMiniKey = booleanPreferencesKey("useDenseMini")
// Mini buttons order (JSON array of button names)
val MiniButtonsOrderKey = stringPreferencesKey("miniButtonsOrder")
// Preferred mini buttons (JSON array of visible button names)
val PreferredMiniButtonsKey = stringPreferencesKey("preferredMiniButtons")
// Compact notification buttons (JSON array of indices, max 3)
val PreferredCompactNotificationButtonsKey = stringPreferencesKey("preferredCompactNotificationButtons")
// Blacklisted home sections (JSON array of section names)
val BlacklistedHomeSectionsKey = stringPreferencesKey("blacklistedHomeSections")
// Enable gesture (swipe to change song etc.)
val EnableGestureKey = booleanPreferencesKey("enableGesture")
// Volume gesture enabled (vertical swipe to change volume)
val VolumeGestureEnabledKey = booleanPreferencesKey("volumeGestureEnabled")
// Use less data for images (image optimization)
val UseLessDataImageKey = booleanPreferencesKey("useLessDataImage")

// === BlackHole-ported playback settings ===

// Streaming quality (mobile): "96 kbps", "160 kbps", "320 kbps"
val StreamingQualityMobileKey = stringPreferencesKey("streamingQualityMobile")
// Streaming quality (WiFi): "96 kbps", "160 kbps", "320 kbps"
val StreamingQualityWifiKey = stringPreferencesKey("streamingQualityWifi")
// YouTube stream quality: "Low" or "High"
val YtStreamQualityKey = stringPreferencesKey("ytStreamQuality")
// Load last played song on startup
val LoadLastKey = booleanPreferencesKey("loadLast")
// Reset position on skip
val ResetOnSkipKey = booleanPreferencesKey("resetOnSkip")
// Enforce repeat mode
val EnforceRepeatKey = booleanPreferencesKey("enforceRepeat")
// Autoplay similar songs after queue ends
val AutoplayKey = booleanPreferencesKey("autoplay")
// Cache song during playback
val CacheSongKey = booleanPreferencesKey("cacheSong")

// === BlackHole-ported download settings ===

// Download filename format: 0="Title - Artist", 1="Artist - Title", 2="Title"
val DownloadFilenameKey = intPreferencesKey("downloadFilename")
// Create album folder when downloading
val CreateAlbumFolderKey = booleanPreferencesKey("createAlbumFolder")
// Create YouTube folder when downloading
val CreateYoutubeFolderKey = booleanPreferencesKey("createYoutubeFolder")
// Download lyrics along with song
val DownloadLyricsKey = booleanPreferencesKey("downloadLyrics")

// === BlackHole-ported other settings ===

// Include or exclude folder mode: false=Exclude, true=Include
val IncludeOrExcludeKey = booleanPreferencesKey("includeOrExclude")
// Included/Excluded paths (JSON array of folder paths)
val IncludedExcludedPathsKey = stringPreferencesKey("includedExcludedPaths")
// Minimum audio length in seconds (filter short audio files)
val MinAudioLengthKey = intPreferencesKey("minAudioLength")
// Live search (search as you type)
val LiveSearchKey = booleanPreferencesKey("liveSearch")
// Use downloaded version if available
val UseDownKey = booleanPreferencesKey("useDown")
// Get lyrics online
val GetLyricsOnlineKey = booleanPreferencesKey("getLyricsOnline")
// Support equalizer
val SupportEqKey = booleanPreferencesKey("supportEq")
// Auto backup location path
val AutoBackupLocationKey = stringPreferencesKey("autoBackupLocation")


// === Additional BlackHole-ported + new feature keys ===

// Color Hue for accent colors (100, 200, 400, 700)
val ColorHueKey = intPreferencesKey("colorHue")

// Music Language (multi-select, JSON array of language names)
val MusicLanguageKey = stringPreferencesKey("musicLanguage")

// Chart Location (country name string)
val ChartLocationKey = stringPreferencesKey("chartLocation")

// Minimum audio length in seconds for local scan
val MinDurationKey = intPreferencesKey("minDuration")

// Sleep timer duration in minutes (0 = off)
val SleepTimerDurationKey = intPreferencesKey("sleepTimerDuration")

// Playback speed (0.5 to 2.0, default 1.0)
val PlaybackSpeedKey = floatPreferencesKey("playbackSpeed")

// Fade out duration in seconds on pause/stop (0 = disabled)
val FadeOutDurationKey = floatPreferencesKey("fadeOutDuration")

// A-B repeat markers (JSON: {"a": timestamp_ms, "b": timestamp_ms})
val AbRepeatKey = stringPreferencesKey("abRepeat")

// Lyrics sync offset in milliseconds (can be negative)
val LyricsSyncOffsetMsKey = intPreferencesKey("lyricsSyncOffsetMs")
