...
object PlayerWidgetUpdater {
    suspend fun update(
        ...
        runCatching {
            ...
            val glanceIds = manager.getGlanceIds(DhunPlayerWidget::class.java)
            ...
            glanceIds.forEach { glanceId ->
                ...
                DhunPlayerWidget().update(context, glanceId)
            }
        }.onFailure {
            Timber.tag("PlayerWidgetUpdater").w(it, "Unable to update Dhun player widget")
        }
    }
