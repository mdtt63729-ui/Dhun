...
import com.arturo254.dhun.widget.PlayerWidgetActions.openAppIntent
...
class DhunPlayerWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(
        ...
        provideContent {
            ...
            GlanceTheme(colors = DhunWidgetColors) {
...
private fun PlayerWidgetContent(state: PlayerWidgetState, uiPrefs: WidgetUiPrefs) {
    ...
    val artist = state.artist.ifBlank { "Dhun" }
