...
import com.arturo254.dhun.constants.QueueEditLockKey
...
import com.arturo254.dhun.ui.component.MediaMetadataListItem
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.arturo254.dhun.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.arturo254.dhun.together.TogetherSessionState.Joined).role is com.arturo254.dhun.together.TogetherRole.Guest
        ...
        collapsedContent = {
            when (playerDesignStyle) {
                ...
                PlayerDesignStyle.PIXEL -> {
                    // PixelPlayer style uses its own inline toggle row
                }
            }
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.arturo254.dhun.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.arturo254.dhun.together.TogetherRole.Guest
                                                                if (isGuest) {
