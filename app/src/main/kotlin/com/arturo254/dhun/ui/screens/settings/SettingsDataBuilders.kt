            ...
            SettingsGroup(
                ...
                items = listOf(
                    SettingsItem(
                        ...
                        title = stringResource(R.string.account),
                        subtitle = "Login, tokens, sync",
                        accentColor = MaterialTheme.colorScheme.primary,
                        keywords = listOf("account", "login", "youtube", "token", "cookie", "sync", "ytmusic"),
                        onClick = { resetSearch(); navController.navigate("account") },
                    ),
                ),
            ),
        )
            ...
            SettingsGroup(
                ...
                items = listOf(
                    ...
                    SettingsItem(
                        ...
                        subtitle = "Translate lyrics using AI (OpenAI/Gemini/Custom)",
                        accentColor = MaterialTheme.colorScheme.tertiary,
                        keywords = listOf("ai", "translate", "translation", "lyrics", "openai", "gemini", "custom"),
                        onClick = { resetSearch(); navController.navigate("settings/ai") },
                    ),
                ),
            ),
        )
