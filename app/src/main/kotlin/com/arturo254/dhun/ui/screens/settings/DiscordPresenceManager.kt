...
import com.arturo254.dhun.utils.DiscordImageResolver
import com.arturo254.dhun.utils.DiscordSocialSdkBridge
import com.arturo254.dhun.utils.DiscordSocialSdkTokenStore
...
object DiscordPresenceManager {
    ...
    private suspend fun ensureSocialSdkClientReady(context: Context): Boolean {
        ...
        if (com.arturo254.dhun.utils.DiscordSocialSdkInitCompat.getApplicationContext() == null) {
    ...
    private suspend fun updatePresenceViaSocialSdk(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Dhun"
