...
package com.arturo254.dhun.kugou

import com.arturo254.dhun.kugou.models.Keyword
import com.arturo254.dhun.kugou.models.SearchLyricsResponse
import com.arturo254.dhun.kugou.models.SearchSongResponse
...
object KuGou {
    ...
    private suspend fun downloadLyrics(id: Long, accessKey: String): String =
        client.get("https://lyrics.kugou.com/download") {
            ...
            .let { response ->
                Json.parseToJsonElement(response)
                    ...
                    ?.jsonPrimitive
                    ?.content
                    ?: throw IllegalStateException("KuGou lyrics response has no content")
            }
